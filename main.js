{"url":"https://github.com/Endy-gif/Zeyno-bot"}
...
if (!methodCodeQR && !methodCode && !fs.existsSync(`./${authFile}/creds.json`)) {
    ...
    const redSoft = chalk.hex('#E74C3C');   // Soft red
        ...
        const a = cyan1('╭━━━━━━━━━━━━━• 𝐙𝐄𝐘𝐍𝐎 𝐂𝐎𝐑𝐄 •━━━━━━━━━━━━━');
    const b = cyan1('╰━━━━━━━━━━━━━• 𝐙𝐄𝐘𝐍𝐎 𝐄𝐍𝐃 •━━━━━━━━━━━━━');
    const linea = cyan2('   ─────────◈────────◈─────────◈─────────');
    ...
    const istruzioni = [
        ...
        whiteSoft.italic(''),
        cyan1.italic('                𝐙𝐄𝐘𝐍𝐎 𝐒𝐘𝐒𝐓𝐄𝐌 • 𝐕𝟏.𝟎.𝟎'),
    ];
...
${green.italic('\nSupporto Tecnico: Contatta lo sviluppatore nel config')}
`);
    }
...
(async () => {
    try {
        ...
        console.log(chalk.hex('#2ECC71').bold(`𝐙𝐄𝐘𝐍𝐎 𝐁𝐎𝐓 connesso correttamente`));
    } catch (error) {
